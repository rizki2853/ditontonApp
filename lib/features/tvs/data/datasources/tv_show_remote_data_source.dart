...
abstract class TVShowRemoteDataSource {
  ...
  Future<List<TVShowModel>> getTopRateTvShow();
  Future<TvShowDetailModel> getTvDetail(int id);
...
class TVShowRemoteDataSourceImpl implements TVShowRemoteDataSource {
  ...
  @override
  Future<List<TVShowModel>> getTopRateTvShow() async {
    final response =
  ...
  @override
  Future<TvShowDetailModel> getTvDetail(int id) async {
